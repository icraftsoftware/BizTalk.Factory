...
{
	public class UnitTestInputMessageReceiveLocation : ReceiveLocation<NamingConvention>
	{
		public UnitTestInputMessageReceiveLocation()
		{
			Name = ReceiveLocationName.About("InputMessage").FormattedAs.Xml;
			Enabled = true;
