...
{
	[TestFixture]
	public class ReleaseBatchFixture : SchemaFixture<ReleaseBatch>
	{
		[Test]
		public void ValidateReleaseBatch()
		{
			var instance = MessageFactory.CreateMessage<ReleaseBatch>(ResourceManager.LoadString("ReleaseBatch.xml"));
