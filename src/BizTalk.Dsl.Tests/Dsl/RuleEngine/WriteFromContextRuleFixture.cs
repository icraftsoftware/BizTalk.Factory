...
{
	[TestFixture]
	public class WriteFromContextRuleFixture : PolicyFixture<WriteFromContextRuleFixture.WriteFromContextRuleSet>
	{
		[Test]
			...
			public WriteFromContextRuleSet()
			{
				...
				Rules.Add(
					Rule("WriteFromContext")
						...
						.Then(() => Context.Write(TrackingProperties.ProcessName, Context.Read(BtsProperties.MessageType)))
					);
			}
		}
	}
