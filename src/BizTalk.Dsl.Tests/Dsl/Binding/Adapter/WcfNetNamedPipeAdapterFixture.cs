...
namespace Be.Stateless.BizTalk.Dsl.Binding.Adapter
{
	...
	public class WcfNetNamedPipeAdapterFixture
	{
		...
		public void ProtocolTypeSettingsAreReadFromRegistry()
		{
			...
			Assert.That(wsa.ProtocolType.Name, Is.EqualTo("WCF-NetNamedPipe"));
			Assert.That(wsa.ProtocolType.Capabilities, Is.EqualTo(907));
			Assert.That(wsa.ProtocolType.ConfigurationClsid, Is.EqualTo("148d2e28-d634-4127-aa9e-7d6298156bf1"));
		}
	}
}
