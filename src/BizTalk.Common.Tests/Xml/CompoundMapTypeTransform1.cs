...
namespace Be.Stateless.BizTalk.Xml
{
	...
	internal class CompoundMapTypeTransform1 : TransformBase
	{
		static CompoundMapTypeTransform1()
		{
			_xmlContent = ResourceManager.LoadString("Data.CompoundMapTypeTransform1.xsl");
		}
