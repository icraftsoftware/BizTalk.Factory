...
#pragma warning disable 1584,1711,1572,1581,1580
	/// <summary>
	/// <see cref="XPathMutatorStream"/> that goes along with <see cref="T:Be.Stateless.BizTalk.MicroComponent.ContextPropertyExtractor"/>
	/// and <see cref="T:Be.Stateless.BizTalk.Component.ContextPropertyExtractorComponent"/>.
	/// </summary>
#pragma warning restore 1584,1711,1572,1581,1580
	public static class XPathMutatorStreamFactory
	{
		public static XPathMutatorStream Create(Stream stream, IEnumerable<XPathExtractor> extractors, Func<IBaseMessageContext> messageContextAccessor)
		{
