...
namespace Be.Stateless.BizTalk.ContextBuilders.Send.Batch
{
	public class AggregateProcessResolver : IContextBuilder
	{
		...
		public void Execute(IBaseMessageContext context)
		{
			...
			{
				context.SetProcessName(Factory.Areas.Batch.Processes.Aggregate);
			}
		}
