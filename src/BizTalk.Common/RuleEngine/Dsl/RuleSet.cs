...
namespace Be.Stateless.BizTalk.RuleEngine.Dsl
{
	...
	/// </summary>
	/// <remarks>
	/// To effectively work, invocation of static members of a class must be
	/// enabled for the rule engine. See http://msdn.microsoft.com/en-us/library/aa950269.aspx.
	/// </remarks>
	public class RuleSet : RuleSetBase
	{
		public static implicit operator Microsoft.RuleEngine.RuleSet(RuleSet fromRuleSet)
		{
			...
			foreach (var rule in fromRuleSet.Rules)
			{
		...
		public RuleSet(string name, int majorRevision, int minorRevision)
			: this(name)
		{
