...
{
	/// <summary>
	/// Allows to setup the callback to be carried out by the <see cref="IStubService"/> stub service upon either the
	...
	/// </typeparam>
	public interface IOperationCallbackSetup<TContract> : IHideObjectMembers
	...
	/// </typeparam>
	public interface IOperationCallbackSetup<TContract, TResult> : IHideObjectMembers
		where TContract : class
	{
		/// <summary>
		/// Specifies a callback to invoke when the method is called.
