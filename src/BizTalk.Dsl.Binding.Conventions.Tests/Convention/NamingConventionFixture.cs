...
namespace Be.Stateless.BizTalk.Dsl.Binding.Convention
{
	...
	public class NamingConventionFixture
	{
		...
		private class SampleApplication : ApplicationBinding<NamingConvention<Party, MessageName>>
		{
			...
			public IReceivePort<NamingConvention<Party, MessageName>> CustomerOneWayReceivePort { get; private set; }

			public ISendPort<NamingConvention<Party, MessageName>> CustomerTwoWaySendPort { get; private set; }
