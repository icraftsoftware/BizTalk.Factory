...
{
	public abstract class WcfNetTcpAdapter<TConfig> : WcfAdapterBase<NetTcpBindingElement, TConfig>
		where TConfig : AdapterConfig,
			IAdapterConfigIdentity,
			// TODO Custom IAdapterConfigBinding,
			// TODO Custom IAdapterConfigEndpointBehavior,
			...
			new()
	{
		...
		protected WcfNetTcpAdapter() : base("netTcpBinding") { }
