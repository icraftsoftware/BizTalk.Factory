...
namespace Be.Stateless.BizTalk.Dsl.Binding.Adapter
{
	public abstract partial class HttpAdapter
	{
		...
		public class Inbound : HttpAdapter, IInboundAdapter
		{
			public Inbound()
			{
				ResponseContentType = MediaTypeNames.Text.Xml;
				ReturnCorrelationHandle = true;
				SuspendFailedRequests = true;
			}
			...
			protected override void Save(IPropertyBag propertyBag)
			{
				...
				propertyBag.WriteAdapterCustomProperty("SuspendFailedRequests", SuspendFailedRequests);
			...
			/// </para>
			/// </remarks>
			public bool SuspendFailedRequests { get; set; }
