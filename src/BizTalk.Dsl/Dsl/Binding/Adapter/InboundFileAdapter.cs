...
{
	public class InboundFileAdapter : FileAdapter, IInboundAdapter
	{
		private InboundFileAdapter()
		{
			FileMask = "*.xml";
		...
		public InboundFileAdapter(Action<InboundFileAdapter> adapterConfigurator) : this()
		{
