...
{
	/// <summary>
	/// Translates a <see cref="Be.Stateless.BizTalk.Dsl.Pipeline"/>-derived pipeline into a structure of objects that
	/// support binding-compliant serialization.
	/// </summary>
	internal class PipelineBindingBuilderVisitor : PipelineDesignerDocumentBuilderVisitor
	{
