...
namespace Be.Stateless.BizTalk.Dsl.Pipeline
{
	public class ReceivePipelineStageList : StageList, IReceivePipelineStageList
	{
		...
		public IStage Decode { get; private set; }

		public IStage Disassemble { get; private set; }

		public IStage Validate { get; private set; }

		public IStage ResolveParty { get; private set; }
